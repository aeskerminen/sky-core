...
export default class Sidebar extends React.Component {
    ...
    render() {
        return (
            <aside className={this.state.d_class} style={{ height: '100%' }} aria-label="Sidebar" onMouseEnter={() => {this.setState({d_class: "w-36"})}} onMouseLeave={() => {this.setState({d_class: "w-16"})}}>
