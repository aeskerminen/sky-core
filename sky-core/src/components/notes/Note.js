    ...
    return (
      <div className="flex flex-col mr-1 ml-1 bg-slate-100 space-y-2 shadow-md">
        <button
          ...
          className="bg-slate-100 hover:bg-gray-50 active:bg-gray-100 m-1 p-1"
        >
          <div className="flex flex-row items-center">
            ...
            <button
              ...
              className="bg-white hover:bg-gray-50 active:bg-gray-100 border border-black px-3 py-1 ml-auto rounded-full"
            >
              x
            </button>
          </div>
