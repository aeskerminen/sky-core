  ...
  if (props.displayPDF) {
    ...
    return (
      <div>
        ...
        />
        <label className="cursor-grab" for="pdffile">
          <svg
        ...
        <div>
          <button
            type="button"
            className="mt-2 mr-2 bg-black text-white border-none w-20 cursor-pointer shadow-md"
          ...
          <button
            type="button"
            className="bg-black text-white border-none w-20 cursor-pointer shadow-md"
